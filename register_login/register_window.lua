...
function showRegisterGui_func ()
	...
	gLabel[12] = guiCreateLabel(12,98,150,17,"LSG-RL",false,gWindow["register"])
...
function showBeginGui_func ()
	...
	gLabel["anfangsAdresse"] = guiCreateLabel(0.1011,0.7707,1,0.1729,"LSG-RL",true,gWindow["welcomeInfo"])
